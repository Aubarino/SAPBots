...
function TOOL.BuildCPanel(panel)
    ...
    function UpdateColors(col)
        ...
        GetConVar("sapbotcreator_sapteamcolor_r"):SetFloat(col.r)
        GetConVar("sapbotcreator_sapteamcolor_g"):SetFloat(col.g)
        GetConVar("sapbotcreator_sapteamcolor_b"):SetFloat(col.b)
    end
